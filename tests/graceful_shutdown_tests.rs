...
async fn test_register_and_shutdown_component() {
    ...
    shutdown
        .register_component("test_component".to_string(), move || {
...
async fn test_shutdown_multiple_components() {
    ...
    for i in 0..3 {
        ...
        shutdown
            .register_component(format!("component_{}", i), move || {
...
async fn test_component_shutdown_error_handling() {
    ...
    shutdown
        .register_component("failing_component".to_string(), || async {
    ...
    shutdown
        .register_component("success_component".to_string(), move || {
...
async fn test_component_shutdown_timeout() {
    ...
    shutdown
        .register_component("slow_component".to_string(), || async {
...
async fn test_component_panic_handling() {
    ...
    shutdown
        .register_component("panicking_component".to_string(), || async {
...
async fn test_concurrent_component_registration() {
    ...
    for i in 0..10 {
        ...
        let handle = tokio::spawn(async move {
            shutdown_clone
                .register_component(format!("concurrent_{}", i), move || {
                    let counter = counter_clone.clone();
                    async move {
                        *counter.lock().await += 1;
                        Ok(())
...
async fn test_shutdown_ordering() {
    ...
    for i in 0..3 {
        ...
        let component_id = i;
        shutdown
            .register_component(format!("ordered_{}", i), move || {
